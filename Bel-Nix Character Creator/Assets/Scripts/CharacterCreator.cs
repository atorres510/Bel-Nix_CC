...
public class CharacterCreator : MonoBehaviour {
    ...
    [HideInInspector]
    public int chestType = 0; //0 none, 1 Acup, 2 Bcup
    [HideInInspector]
    public int size = 0; //0 medium, 1 small
    [HideInInspector]
    public int raceType = 0;   //0 Base, 1 Dragonborn, 2 tiefling
    [HideInInspector]
    public int bodyType = 1; // 0 Bony, 1 Fit
    [HideInInspector]
    public int accessoryType = 0; // 0 backitem, 1, handitem, 2, helmetitem, 3 shoulderitems, 4 capeitems
    ...
    [HideInInspector]
    public int hairSprite = 1, capeSprite = 0, backSprite = 0, shoulderSprite = 0, handSprite = 0, headSprite = 0, helmetSprite = 0, scarfSprite = 0, racialSprite = 0;
