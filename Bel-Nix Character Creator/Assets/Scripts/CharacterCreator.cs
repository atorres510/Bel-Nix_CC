...
public class CharacterCreator : MonoBehaviour {
    ...
    string ConstructKey(string keyType) {
        ...
        switch (keyType) {
            ...
            case "CHESTTYPEKEY":
                ...
                key = "ChestType_" + sizeStrings[size] + "_" + bodyStrings[bodyType] /*GetSpriteName(paperDollLayers[1])*/;

                break;

            case "CLOTHINGTYPEKEY":

                key = "ClothingType_" + sizeStrings[size] + "_" + bodyStrings[bodyType]/*GetSpriteName(paperDollLayers[1])*/ + "_" + chestStrings[chestType];
            ...
            case "HANDTYPEKEY":
                ...
                key = "HandType_" + sizeStrings[size] + "_" + raceStrings[raceType] + "_" + bodyStrings[bodyType] /*GetSpriteName(paperDollLayers[1])*/;
    ...
    public void ApplyPaperdollToToken(Token token) {
        ...
        token.ChangeTokenName(currentToken.tokenName);
        token.ChangeTokenRace(raceID);
